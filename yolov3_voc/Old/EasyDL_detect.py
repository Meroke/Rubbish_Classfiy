...
def detectEasyDL():
    global IMAGE_FILEPATH, rubbish_class
    flag = 0
    ...
    if(len(res_load['results']) > 0):
        ...
        for i in range(len(res_load['results'])):
            ...
            cv2.putText(image, text, (x, y - 5), cv2.FONT_HERSHEY_TRIPLEX, 0.5, 125, 2)  # 写字
            print(text)
...
if __name__  == "__main__":
    pic_path = "/home/meroke/Python_pro/A_polyp/pic_save_every/laji4.jpg"
    name = detectEasyDL()